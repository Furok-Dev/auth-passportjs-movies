/**
 * Aqui estaran los datos falsos
 * que usaremos para alimentar nuestra aplicacion
 * estos datos fueron creados en "Moockaru"
 */
...
//Vamos a crear una utilidad para que nos filtre las peliculas por el tag
function filteredMoviesMock(tag) {
  return moviesMock.filter((movie) => movie.tags.includes(tag));
}

//Luego creamos una clase para usar los servicios de mocks
